 ...
 *
 */
public class DecodeAndPlayAudioAndVideo1 {
    ...
    public static void main(String[] args) {
        ...
        String filename = "http://118.166.84.41/final/music/qqqq.flv";
        ...
        // Open up the container
        if (container.open("http://118.166.84.41/final/music/qqqq.flv", IContainer.Type.READ, null) < 0) {
            throw new IllegalArgumentException("could not open file: " + filename);
        }
